...
@Component({
  ...
  standalone: true,
  template: `
    <div class="relative max-w-[100vw] max-h-[100vh] p-5 inset-0 flex items-center justify-center z-50">
      <div class="relative rounded p-6 max-w-full bg-cyan-950 ring ring-cyan-600 shadow-xl shadow-cyan-600/50">
